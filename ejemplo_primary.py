...
print(get_market_data("DLR/MAR25A"))
...
print(f"\nDetalle de un instrumento: {get_instrument_details('DLR/MAR25A')}")

for ins in todos_los_instrumentos.get('instruments'):
    print(ins)

print(f"\nhistórico de DLR/MAR25A: {get_trade_history('DLR/MAR25A','2023-05-01','2023-06-01')}")

#print(f"\n{get_market_data('PAMP/AGO24'),[MarketDataEntry.LAST],Environment.REMARKET}")

orden = send_order('DLR/MAR25A',side=Side.BUY,size=10,price=2555,order_type=OrderType.LIMIT)
print(f"\nenviar orden: {orden}")

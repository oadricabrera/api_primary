...
print(get_market_data("GGAL/FEB26"))
...
print(f"\nDetalle de un instrumento: {get_instrument_details('GGAL/FEB26')}")

for ins in todos_los_instrumentos.get('instruments'):
    print(ins)

print(f"\nhistórico de GGAL/FEB26: {get_trade_history('GGAL/FEB26','2023-05-01','2023-06-01')}")

#print(f"\n{get_market_data('PAMP/AGO24'),[MarketDataEntry.LAST],Environment.REMARKET}")

orden = send_order('GGAL/FEB26',side=Side.BUY,size=10,price=2555,order_type=OrderType.LIMIT)
print(f"\nenviar orden: {orden}")
